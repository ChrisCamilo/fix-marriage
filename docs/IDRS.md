...
| `patches.txt` | **2.678** linhas (1.832 + 781 de cabeçalho de slice, 2026-09-18, + 65 de cauda de IDR, 2026-09-24) |
| `deterministicos.txt` | **479** |
| `verify` com `BASE_N=1338` | **0 válidos, 12 falsos, 1.328 pulados** (480 determinísticos + 783 de cabeçalho + 65 de cauda) — ver o `AGENTS.md` — os 10 estão explicados no `AGENTS.md` |
